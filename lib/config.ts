...
export const siteConfig = {
  ...
  projects: [
    ...
    },
    {
      ...
      sector: "DevTools",
      ref: "REF: RESB-07",
      stack: ["Next.js 15", "React 19", "MDX", "Tailwind v4", "TypeScript"],
      desc: "The AI Ops Manual — a curated, opinionated directory of AI tools, executable workflows, and developer configs. Ships with a workflow runner, AI chat assistant, personal stack builder, and community endorsements.",
      meta: "Status: v2.0",
      dotColor: "bg-[#034694]",
      tag: "progress" as const,
      video: "",
